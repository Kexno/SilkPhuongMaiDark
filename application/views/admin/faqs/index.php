                        ...
                        <table id="data-table" class="table table-bordered table-hover dataTable" role="grid">
                            <thead>
                                <tr>
                                    ...
                                    <th style="width: 30%"><?php echo lang('text_question') ?></th>
            ...
            <div class="modal-body form">
                ...
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#tab_language" data-toggle="tab"><?php echo $heading_title ?></a></li>
                        <li><a href="#tab_status" data-toggle="tab"><?php echo lang('text_status'); ?></a></li>
                    </ul>
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    <div class="form-group">
                                                        <label><?php echo lang('text_question'); ?></label>
                                                ...
                                                <div class="col-xs-12">
                                                    <div class="form-group">
                                                        <label><?php echo lang('text_answer'); ?></label>
                        ...
                        <div class="tab-pane" id="tab_status">
                            <div class="box-body">
                                <div class="col-xs-12">
                                    ...
                                    <div class="form-group">
                                        <label>Sắp xếp</label>
                                        <input id="order_fa" name="order_fa" placeholder="Sắp xếp" class="form-control" type="text" />
                                    </div>
                                </div>
                            </div>
                        </div>
