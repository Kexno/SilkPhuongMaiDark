    ...
    <div class="modal-dialog" style="width: 90%">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title" id="title-form">Set sơ chế tuần này</h3>
            </div>
                ...
                <div class="box-body" style="padding-bottom: 60px; padding-right: 20px; padding-left: 20px;">
                    <div class="row">
                        ...
                        <fieldset class="form-group album-contain">
                            <legend>Set sơ chế tuần này</legend>
                                            ...
                                            <div class="col-right">
                                                <div class="nav-tabs-custom">
                                                    <ul class="nav nav-tabs">
                                                        <?php if (!empty($this->config->item('cms_set_combo'))) foreach ($this->config->item('cms_set_combo') as $key => $value): ?>
                                                            <li class="<?php echo $key == 0 ? 'active' : '' ?>"><a
                                                                    href="#tab_<?php echo $key ?>"
                                                                    data-toggle="tab"
                                                                    aria-expanded="true"><?php echo $value ?></a>
                                                            </li>
                                                        <?php endforeach; ?>
                                                    </ul>
